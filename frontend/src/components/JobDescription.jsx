    ...
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div className="my-4">
        <h1 className="font-bold my-1">
          Role: <span className="pl-4 font-normal text-gray-800">Frontend</span>
        </h1>
        <h1 className="font-bold my-1">
          Location:{" "}
        ...
        <h1 className="font-bold my-1">
          ...
          <span className="pl-4 font-normal text-gray-800">
            ...
            deserunt ducimus vitae modi eveniet!
          </span>
        </h1>
        <h1 className="font-bold my-1">
          Experience:{" "}
        ...
        <h1 className="font-bold my-1">
          Salary: <span className="pl-4 font-normal text-gray-800">7 LPA</span>
        </h1>
        <h1 className="font-bold my-1">
          Total Applicants:{" "}
        ...
        <h1 className="font-bold my-1">
          Posted Date:{" "}
          <span className="pl-4 font-normal text-gray-800">12-2-25</span>
        </h1>
      </div>
    </div>
  );
